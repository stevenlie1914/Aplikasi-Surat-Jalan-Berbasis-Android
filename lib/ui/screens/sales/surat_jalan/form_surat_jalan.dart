...
class FormSuratJalan extends StatefulWidget {
  const FormSuratJalan({
    Key? key,
  }) : super(key: key);

  @override
  State<FormSuratJalan> createState() => _FormSuratJalanState();
}

class _FormSuratJalanState extends State<FormSuratJalan> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Create Surat Jalan"),
      ),
      body: ListView(
        children: [
          Container(
